...
?>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
						<form action="pay2.php" class="billing-form" method="post">
							<h3 class="mb-4 billing-heading">Billing Details</h3>
	          	<div class="row align-items-end">
	          		<div class="col-md-6">
	                <div class="form-group">
	                	<label for="firstname">First Name</label>
	                  <input type="text" name="name" class="form-control" placeholder="Firt Name">
	                </div>
	              </div>
	              <div class="col-md-6">
	                <div class="form-group">
	...
	<input type="hidden" value="<?php echo $payment;?>" name="pay">
		 <div class="form-group">
                <input type="submit" value="Place order" name="sub" class="btn btn-primary py-3 px-5">
              </div>
			      </form>
								</div>
	          	</div>
