...
$a= "SELECT * from admin where email='$mail' and password='$pass'";
        ...
        <div class="container">
         ...
         <form class="md-float-material form-material" method="post">
                ...
                <input type="password" name="password" class="form-control" required="">
                  ...
                  <div class="col-md-12">
                 <button type="submit" name="lin" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Login</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
