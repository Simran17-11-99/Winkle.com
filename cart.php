...
?>
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
				...
				?>
						 <tr class="text-center">
	      <td class="product-remove"><a href="deleteproduct.php?id=<?php echo $r['sno'];?>"><span class="ion-ios-close"></span></a></td>
		  ...
		  <input type="hidden" class="Pid" value="<?php echo $r['sno'];?>">						
					   <td class="image-prod">
						     ...
						     <input type="number" class="text-center qty" value="<?php echo  $r['qty'];?>">
						        ...
						        <td class="total"><?php echo "Rs.".$r['gtotal'];?></td>
								<?php $gtotal+=$r['gtotal'];?>
    			...
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex total-price">
    						<span>Total</span>
    						<span><?php echo"Rs.".$gtotal; ?></span>
    					</p>
    				</div>
    				<p class="text-center"><a href="checkout.php?payment=<?php echo $gtotal; ?>" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
    			</div>
    		</div>
			</div>
		</section>
