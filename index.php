...
?>
    ...
    <section id="home-section" class="hero">
	  ...
	  <div class="one-third order-md-last img js-fullheight"  style="background-image:url(Projectimages/page.jpg);">
	          	</div>
    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-md-5 order-md-last d-flex align-items-stretch">
    				<div class="img img-2" style="background-image: url(Projectimages/page.jpg);"></div>
    			</div>
...
$mail=$_POST['mail'];	
$a="INSERT INTO subscriber (Email) values('$mail')";
$b=mysqli_query($conn,$a);
if($b){
	echo"<script>
	alert ('Thankyou for subscription.')
	</script>";
}
else{
    echo"<script>
